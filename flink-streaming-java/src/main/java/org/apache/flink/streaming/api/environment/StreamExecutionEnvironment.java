 ...
 * <p>
 * 流程序执行的上下文，流执行环境能够设置流作业的并行度、设置是否开启链式操作符、设置容错机制、创建数据流源
 * 以及最重要的 —— 存储当前流任务中的 StreamTransformation，用于绘制 StreamGraph
 * <p>
 * 有两个实现类，LocalStreamEnvironment 和 RemoteStreamEnvironment
 */
@Public
