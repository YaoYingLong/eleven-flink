...
public class KafkaSourceReaderMetrics {
    ...
    public KafkaSourceReaderMetrics(SourceReaderMetricGroup sourceReaderMetricGroup) {
        ...
        this.kafkaSourceReaderMetricGroup = sourceReaderMetricGroup
                .addGroup(KAFKA_SOURCE_READER_METRIC_GROUP);
        // 提交消费offsets成功的
        this.commitsSucceeded = this.kafkaSourceReaderMetricGroup
                .counter(COMMITS_SUCCEEDED_METRIC_COUNTER);
        // 提交消费offsets失败的
        this.commitsFailed = this.kafkaSourceReaderMetricGroup
    ...
    public void registerKafkaConsumerMetrics(KafkaConsumer<?, ?> kafkaConsumer) {
        ...
        kafkaConsumerMetrics.forEach((name, metric) ->
